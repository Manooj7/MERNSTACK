...
// module.exports.getAllTodo = async function(callback){
// try{
//     var users= todoModel.find({isDeleted:false});
// callback(null,users);
// }
// catch(err){
// callback(err,null);
...
//            var todos= await todoModel.findOne(query);
...
//     module.exports. getSingleTodoById= async function(query,callback){
//         try{
//             //  var user = await userModel.findOne(filter);
//                var result= await todoModel.findOne(query);
